...
export default function Home() {
    ...
    <div className="mt-15 md:mt-15 flex justify-center items-center min-h-[60vh]">
      <div className="bg-crema rounded-2xl shadow-xl p-8 max-w-xl w-full animate-fade-in text-center">
        ...
        <p className="text-lg mb-8">
          Este es un espacio de la agencia inmobiliaria Barrientos Propiedades dedicado a la comercialización y gestión de campos, brindando la seriedad, cercanía, y compromiso que nos caracteriza.        </p>
  ...
  <NavLink
    to="/publicar"
    className="w-full py-3 rounded-xl font-semibold text-lg shadow bg-[#fbe2a7]
