      ...
      <div className="w-full bg-crema rounded-2xl shadow-xl p-6 sm:p-10 border border-[#ebdbb9]">
        ...
        <div className="text-center max-w-lg mx-auto space-y-6">
          <p style={{ fontFamily: "'PT Serif', serif" }}>
            En <strong>Barrientos Propiedades</strong> conocemos la
          ...
          <p style={{ fontFamily: "'PT Serif', serif" }}>
            ...
            <strong>Dedicación</strong> y <strong>Confianza</strong>.
          ...
          <p style={{ fontFamily: "'PT Serif', serif" }}>
            En <strong>Barrientos Propiedades</strong>, entendemos el valor
